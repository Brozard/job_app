...
class JobPostingsControllerTest < ActionController::TestCase
  ...
  test "should create job_posting" do
    assert_difference('JobPosting.count') do
      post :create, job_posting: { company_id: @job_posting.company_id, description: @job_posting.description, is_applied_for: @job_posting.is_applied_for, is_rejected: @job_posting.is_rejected, posting_date: @job_posting.posting_date, title: @job_posting.title }
    end
  ...
  test "should update job_posting" do
    patch :update, id: @job_posting, job_posting: { company_id: @job_posting.company_id, description: @job_posting.description, is_applied_for: @job_posting.is_applied_for, is_rejected: @job_posting.is_rejected, posting_date: @job_posting.posting_date, title: @job_posting.title }
    assert_redirected_to job_posting_path(assigns(:job_posting))
  end
